...
using Sistema_Votaciones.API.Extensions;
...
namespace Sistema_Votaciones.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Sistema_Votaciones.API", Version = "v1" });
            });
            //services.AddAutoMapper(x => x.AddProfile<MappingProfileExtensions>(), AppDomain.CurrentDomain.GetAssemblies());
            services.DataAcces(Configuration.GetConnectionString("SistemaTicketsconn"));
